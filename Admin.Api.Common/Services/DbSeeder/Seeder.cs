...
namespace StepEbay.Admin.Api.Common.Services.DbSeeder
{
    public class Seeder : ISeeder
    {
        ...
        public async Task AddProducts()
        {
            ...
            await AddProduct("Мобільний телефон Samsung Galaxy M32 6/128 GB Light Blue (SM-M325FLBGSEK)", "samsung_galaxy_m32.png", "", "", 8555, "Екран (6.4\", Super AMOLED, 2400x1080) / MediaTek Helio G80 (2.0 ГГц + 1.8 ГГц) / основна квадрокамера: 64 Мп + 8 Мп + 2 Мп + 2 Мп, фронтальна камера: 20 Мп / RAM 6 ГБ / 128 ГБ вбудованої пам'яті + microSD (до 1 ТБ) / 3G / LTE / GPS / підтримка 2 SIM-карток (Nano-SIM) / Android 11 / 5000 мА·год", string.Empty, ProductCategoryConstant.TELEPHONE, rand.Next(3, 6));
            ...
            await AddProduct("Мобільний телефон Nokia G10 3/32 GB Blue (719901148421)", "175052344.jpg", "", "", 3999, "Екран (6.5\", IPS, 1600x720) / MediaTek Helio G25 (2.0 ГГц) / потрійна основна камера: 13 Мп + 2 Мп + 2 Мп, фронтальна 8 Мп / RAM 3 ГБ / 32 ГБ вбудованої пам'яті + microSD (до 512 ГБ) / 3G / LTE / GPS / підтримка 2 SIM-карток (Nano-SIM) / Android 11 / 5050 мА·год", string.Empty, ProductCategoryConstant.TELEPHONE, rand.Next(3, 6));
