...
namespace StepEbay.Admin.Api.Common.Services.DbSeeder
{
    public class Seeder : ISeeder
    {
        ...
        private async Task AddProduct(string title, string image1, string image2, string image3, decimal price, string desc, string additionalInfo, string category, int rate)
        {
